...
class AlexNet(nn.Module):
    ...
    def __init__(self, num_classes=10):
        ...
        self.features = nn.Sequential(
            # Conv1
            nn.Conv2d(3, 96, kernel_size=5, stride=1, padding=2),  # 32x32
            nn.BatchNorm2d(96),
            ...
            # Conv3
            nn.Conv2d(256, 384, kernel_size=3, stride=1, padding=1),# 15x15
            nn.BatchNorm2d(384),
            nn.ReLU(inplace=True),
            nn.Dropout(0.5),

            # Conv4
            nn.Conv2d(384, 384, kernel_size=3, stride=1, padding=1),# 15x15
            nn.BatchNorm2d(384),
            nn.ReLU(inplace=True),
            nn.Dropout(0.5),

            # Conv5
            nn.Conv2d(384, 256, kernel_size=3, stride=1, padding=1),# 15x15
            nn.BatchNorm2d(256),
            nn.ReLU(inplace=True),
